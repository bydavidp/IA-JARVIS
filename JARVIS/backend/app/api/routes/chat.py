...
@router.get("/modes")
async def get_modes() -> list[ChatMode]:
    """Retorna los modos de chat disponibles."""
    mode_descriptions = {
        "general": "Conversación normal y conceptos generales de ingeniería",
        "code": "Análisis y explicación de código (Python, Java, C++)",
        "math": "Problemas y conceptos matemáticos",
        "networks": "Redes, protocolos y sistemas distribuidos"
    }

    return [
        ChatMode(name=mode, description=desc)
